...
// console.log(x);
// // Логическое И
// console.log(5 && 6 && "world");
// //  Логическое ИЛИ
// console.log(false || 6 || null || 65);
// //  Логическое НЕ
// console.log(!false);
...
// Один из встроенных объектов в язык. 
// Предоставляет набор методов для работы с числами.
// Знание всех методов наизусть не требуется, только некоторых, наиболее полезных.
