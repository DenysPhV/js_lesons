...
// const firstInvoke = logAndInvokeAction('kiwi@mail.uk', service.subscribe); просто дописать .bind(service)
...
// const secondInvoke = logAndInvokeAction('poly@hotmail.de', service.unsubscribe); просто дописать .bind(service)
